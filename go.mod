...
require (
	...
	github.com/apache/incubator-yunikorn-core v0.0.0-20211207190138-7ccbebf8230d
	github.com/apache/incubator-yunikorn-scheduler-interface v0.11.1-0.20211103035638-29e980cee5f1
