...
import (
	...
	scheme "github.com/apache/incubator-yunikorn-k8shim/pkg/client/clientset/versioned/scheme"
...
func newApplications(c *ApacheV1alpha1Client, namespace string) *applications {
	return &applications{
		client: c.RESTClient(),
		ns:     namespace,
	}
