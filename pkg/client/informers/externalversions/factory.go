...
type SharedInformerFactory interface {
	...
	Apache() yunikornapacheorg.Interface
}

func (f *sharedInformerFactory) Apache() yunikornapacheorg.Interface {
	return yunikornapacheorg.New(f, f.namespace, f.tweakListOptions)
}
